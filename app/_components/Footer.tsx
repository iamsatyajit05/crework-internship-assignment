...
export default function Footer() {
    return (
        <footer className="w-full bg-[#181616]">
            <div className="max-w-screen-xl m-auto px-5 py-10 flex flex-col items-center gap-6 sm:gap-10">
                <div className="w-full flex flex-col sm:flex-row justify-between items-center sm:items-start gap-6">
                    ...
                    <div className="flex flex-grow lg:flex-row justify-center gap-16 md:gap-8 lg:gap-32">
                    ...
                    <div>
                        <div className="flex gap-2">
                            <a target="_blank" href="https://twitter.com/CreworkHQ">
                                <Image src="/twitter.svg" alt="twitter" width={32} height={32} className="w-5 h-5 md:w-10 md:h-10" />
                            </a>
                            <a target="_blank" href="https://www.linkedin.com/company/creworkhq/">
                                <Image src="/linkedin.svg" alt="linkedin" width={32} height={32} className="w-5 h-5 md:w-10 md:h-10" />
                            </a>
                            <a target="_blank" href="https://peerlist.io/company/crework">
                                <Image src="/peerlist.svg" alt="peerlist" width={32} height={32} className="w-5 h-5 md:w-10 md:h-10" />
                            </a>
                            <a target="_blank" href="https://www.instagram.com/creworkhq">
                                <Image src="/instagram.svg" alt="instagram" width={32} height={32} className="w-5 h-5 md:w-10 md:h-10" />
                            </a>
                        </div>
                    </div>
                </div>
                <div className="w-full md:w-1/2 h-[1px] bg-gradient-to-r from-white" />
                <div>
